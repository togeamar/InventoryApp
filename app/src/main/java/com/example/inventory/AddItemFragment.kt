...
class AddItemFragment : Fragment() {
    ...
    private fun bind(data: data) {
        val price = "%.2f".format(data.price)
        binding.apply {
            itemName.setText(data.name, TextView.BufferType.SPANNABLE)
            itemPrice.setText(price, TextView.BufferType.SPANNABLE)
            itemCount.setText(data.stock.toString(), TextView.BufferType.SPANNABLE)
